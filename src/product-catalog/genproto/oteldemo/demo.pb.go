...
func (x *PaymentStatus) GetAmount() *Money {
	if x != nil {
		return x.Amount
	}
	return nil
...
func (x *OrderResult) GetTransactionId() string {
	if x != nil {
		return x.TransactionId
	}
	return ""
...
func (x *OrderResult) GetTotalCost() *Money {
	if x != nil {
		return x.TotalCost
	}
	return nil
...
type GetOrdersByEmailRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetOrdersByEmailRequest) Reset() {
	*x = GetOrdersByEmailRequest{}
	mi := &file_demo_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOrdersByEmailRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOrdersByEmailRequest) ProtoMessage() {}

func (x *GetOrdersByEmailRequest) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOrdersByEmailRequest.ProtoReflect.Descriptor instead.
func (*GetOrdersByEmailRequest) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{33}
}

func (x *GetOrdersByEmailRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
type GetOrdersByEmailResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetOrdersByEmailResponse) Reset() {
	*x = GetOrdersByEmailResponse{}
	mi := &file_demo_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOrdersByEmailResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOrdersByEmailResponse) ProtoMessage() {}

func (x *GetOrdersByEmailResponse) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOrdersByEmailResponse.ProtoReflect.Descriptor instead.
func (*GetOrdersByEmailResponse) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{34}
}

func (x *GetOrdersByEmailResponse) GetOrders() []*OrderDetail {
	if x != nil {
		return x.Orders
	}
	return nil
...
type OrderDetail struct {
	...
	ShippingTrackingId string                 `protobuf:"bytes,5,opt,name=shipping_tracking_id,json=shippingTrackingId,proto3" json:"shipping_tracking_id,omitempty"`
...
func (x *OrderDetail) GetTotalCost() *Money {
	if x != nil {
		return x.TotalCost
	}
	return nil
...
func (x *OrderDetail) GetShippingTrackingId() string {
	if x != nil {
		return x.ShippingTrackingId
	}
	return ""
...
func (x *OrderDetail) GetShippingAddress() *Address {
	if x != nil {
		return x.ShippingAddress
	}
	return nil
...
func (x *OrderDetail) GetTransactionId() string {
	if x != nil {
		return x.TransactionId
	}
	return ""
...
func (x *RefundOrderRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
type RefundOrderResponse struct {
	...
	Status              string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	RefundTransactionId string                 `protobuf:"bytes,3,opt,name=refund_transaction_id,json=refundTransactionId,proto3" json:"refund_transaction_id,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *RefundOrderResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *RefundOrderResponse) GetRefundTransactionId() string {
	if x != nil {
		return x.RefundTransactionId
	}
	return ""
...
const file_demo_proto_rawDesc = "" +
	...
	"\x06amount\x18\x03 \x01(\v2\x0f.oteldemo.MoneyR\x06amount\"X\n" +
	"\tOrderItem\x12&\n" +
	"\x04item\x18\x01 \x01(\v2\x12.oteldemo.CartItemR\x04item\x12#\n" +
	"\x04cost\x18\x02 \x01(\v2\x0f.oteldemo.MoneyR\x04cost\"\xff\x02\n" +
	...
	"\x05items\x18\x05 \x03(\v2\x13.oteldemo.OrderItemR\x05items\x12\x17\n" +
	...
	"\x18GetOrdersByEmailResponse\x12-\n" +
	"\x06orders\x18\x01 \x03(\v2\x15.oteldemo.OrderDetailR\x06orders\",\n" +
	"\x0fGetOrderRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\"\xe7\x02\n" +
	"\vOrderDetail\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12.\n" +
	"\n" +
	"total_cost\x18\x04 \x01(\v2\x0f.oteldemo.MoneyR\ttotalCost\x120\n" +
	"\x14shipping_tracking_id\x18\x05 \x01(\tR\x12shippingTrackingId\x12<\n" +
	"\x10shipping_address\x18\x06 \x01(\v2\x11.oteldemo.AddressR\x0fshippingAddress\x12)\n" +
	"\x05items\x18\a \x03(\v2\x13.oteldemo.OrderItemR\x05items\x12\x1d\n" +
	"\n" +
	"created_at\x18\b \x01(\tR\tcreatedAt\x12%\n" +
	"\x0etransaction_id\x18\t \x01(\tR\rtransactionId\"E\n" +
	...
	"\x15refund_transaction_id\x18\x03 \x01(\tR\x13refundTransactionId\".\n" +
	"\tAdRequest\x12!\n" +
	...
	"\aConvert\x12#.oteldemo.CurrencyConversionRequest\x1a\x0f.oteldemo.Money\"\x002\xe0\x01\n" +
	"\x0ePaymentService\x12=\n" +
	"\x06Charge\x12\x17.oteldemo.ChargeRequest\x1a\x18.oteldemo.ChargeResponse\"\x00\x12=\n" +
	"\x06Refund\x12\x17.oteldemo.RefundRequest\x1a\x18.oteldemo.RefundResponse\"\x00\x12P\n" +
	"\x10GetPaymentStatus\x12!.oteldemo.GetPaymentStatusRequest\x1a\x17.oteldemo.PaymentStatus\"\x002b\n" +
	"\fEmailService\x12R\n" +
	"\x15SendOrderConfirmation\x12&.oteldemo.SendOrderConfirmationRequest\x1a\x0f.oteldemo.Empty\"\x002\\\n" +
	"\x0fCheckoutService\x12I\n" +
	"\n" +
	"PlaceOrder\x12\x1b.oteldemo.PlaceOrderRequest\x1a\x1c.oteldemo.PlaceOrderResponse\"\x002\xf9\x01\n" +
	"\fOrderService\x12[\n" +
	"\x10GetOrdersByEmail\x12!.oteldemo.GetOrdersByEmailRequest\x1a\".oteldemo.GetOrdersByEmailResponse\"\x00\x12>\n" +
...
var file_demo_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_demo_proto_goTypes = []any{
	...
	(*RefundRequest)(nil),                  // 24: oteldemo.RefundRequest
	(*RefundResponse)(nil),                 // 25: oteldemo.RefundResponse
	(*GetPaymentStatusRequest)(nil),        // 26: oteldemo.GetPaymentStatusRequest
	(*PaymentStatus)(nil),                  // 27: oteldemo.PaymentStatus
	(*OrderItem)(nil),                      // 28: oteldemo.OrderItem
	(*OrderResult)(nil),                    // 29: oteldemo.OrderResult
	(*SendOrderConfirmationRequest)(nil),   // 30: oteldemo.SendOrderConfirmationRequest
	(*PlaceOrderRequest)(nil),              // 31: oteldemo.PlaceOrderRequest
	(*PlaceOrderResponse)(nil),             // 32: oteldemo.PlaceOrderResponse
	(*GetOrdersByEmailRequest)(nil),        // 33: oteldemo.GetOrdersByEmailRequest
	(*GetOrdersByEmailResponse)(nil),       // 34: oteldemo.GetOrdersByEmailResponse
	(*GetOrderRequest)(nil),                // 35: oteldemo.GetOrderRequest
	(*OrderDetail)(nil),                    // 36: oteldemo.OrderDetail
	(*RefundOrderRequest)(nil),             // 37: oteldemo.RefundOrderRequest
	(*RefundOrderResponse)(nil),            // 38: oteldemo.RefundOrderResponse
	(*AdRequest)(nil),                      // 39: oteldemo.AdRequest
	(*AdResponse)(nil),                     // 40: oteldemo.AdResponse
	(*Ad)(nil),                             // 41: oteldemo.Ad
	(*Flag)(nil),                           // 42: oteldemo.Flag
	(*GetFlagRequest)(nil),                 // 43: oteldemo.GetFlagRequest
	(*GetFlagResponse)(nil),                // 44: oteldemo.GetFlagResponse
	(*CreateFlagRequest)(nil),              // 45: oteldemo.CreateFlagRequest
	(*CreateFlagResponse)(nil),             // 46: oteldemo.CreateFlagResponse
	(*UpdateFlagRequest)(nil),              // 47: oteldemo.UpdateFlagRequest
	(*UpdateFlagResponse)(nil),             // 48: oteldemo.UpdateFlagResponse
	(*ListFlagsRequest)(nil),               // 49: oteldemo.ListFlagsRequest
	(*ListFlagsResponse)(nil),              // 50: oteldemo.ListFlagsResponse
	(*DeleteFlagRequest)(nil),              // 51: oteldemo.DeleteFlagRequest
	(*DeleteFlagResponse)(nil),             // 52: oteldemo.DeleteFlagResponse
}
var file_demo_proto_depIdxs = []int32{
	...
	18, // 13: oteldemo.RefundRequest.amount:type_name -> oteldemo.Money
	18, // 14: oteldemo.PaymentStatus.amount:type_name -> oteldemo.Money
	0,  // 15: oteldemo.OrderItem.item:type_name -> oteldemo.CartItem
	18, // 16: oteldemo.OrderItem.cost:type_name -> oteldemo.Money
	18, // 17: oteldemo.OrderResult.shipping_cost:type_name -> oteldemo.Money
	17, // 18: oteldemo.OrderResult.shipping_address:type_name -> oteldemo.Address
	28, // 19: oteldemo.OrderResult.items:type_name -> oteldemo.OrderItem
	18, // 20: oteldemo.OrderResult.total_cost:type_name -> oteldemo.Money
	29, // 21: oteldemo.SendOrderConfirmationRequest.order:type_name -> oteldemo.OrderResult
	17, // 22: oteldemo.PlaceOrderRequest.address:type_name -> oteldemo.Address
	21, // 23: oteldemo.PlaceOrderRequest.credit_card:type_name -> oteldemo.CreditCardInfo
	29, // 24: oteldemo.PlaceOrderResponse.order:type_name -> oteldemo.OrderResult
	36, // 25: oteldemo.GetOrdersByEmailResponse.orders:type_name -> oteldemo.OrderDetail
	18, // 26: oteldemo.OrderDetail.total_cost:type_name -> oteldemo.Money
	17, // 27: oteldemo.OrderDetail.shipping_address:type_name -> oteldemo.Address
	28, // 28: oteldemo.OrderDetail.items:type_name -> oteldemo.OrderItem
	41, // 29: oteldemo.AdResponse.ads:type_name -> oteldemo.Ad
	42, // 30: oteldemo.GetFlagResponse.flag:type_name -> oteldemo.Flag
	42, // 31: oteldemo.CreateFlagResponse.flag:type_name -> oteldemo.Flag
	42, // 32: oteldemo.ListFlagsResponse.flag:type_name -> oteldemo.Flag
	1,  // 33: oteldemo.CartService.AddItem:input_type -> oteldemo.AddItemRequest
	3,  // 34: oteldemo.CartService.GetCart:input_type -> oteldemo.GetCartRequest
	2,  // 35: oteldemo.CartService.EmptyCart:input_type -> oteldemo.EmptyCartRequest
	6,  // 36: oteldemo.RecommendationService.ListRecommendations:input_type -> oteldemo.ListRecommendationsRequest
	5,  // 37: oteldemo.ProductCatalogService.ListProducts:input_type -> oteldemo.Empty
	10, // 38: oteldemo.ProductCatalogService.GetProduct:input_type -> oteldemo.GetProductRequest
	11, // 39: oteldemo.ProductCatalogService.SearchProducts:input_type -> oteldemo.SearchProductsRequest
	13, // 40: oteldemo.ShippingService.GetQuote:input_type -> oteldemo.GetQuoteRequest
	15, // 41: oteldemo.ShippingService.ShipOrder:input_type -> oteldemo.ShipOrderRequest
	5,  // 42: oteldemo.CurrencyService.GetSupportedCurrencies:input_type -> oteldemo.Empty
	20, // 43: oteldemo.CurrencyService.Convert:input_type -> oteldemo.CurrencyConversionRequest
	22, // 44: oteldemo.PaymentService.Charge:input_type -> oteldemo.ChargeRequest
	24, // 45: oteldemo.PaymentService.Refund:input_type -> oteldemo.RefundRequest
	26, // 46: oteldemo.PaymentService.GetPaymentStatus:input_type -> oteldemo.GetPaymentStatusRequest
	30, // 47: oteldemo.EmailService.SendOrderConfirmation:input_type -> oteldemo.SendOrderConfirmationRequest
	31, // 48: oteldemo.CheckoutService.PlaceOrder:input_type -> oteldemo.PlaceOrderRequest
	33, // 49: oteldemo.OrderService.GetOrdersByEmail:input_type -> oteldemo.GetOrdersByEmailRequest
	35, // 50: oteldemo.OrderService.GetOrder:input_type -> oteldemo.GetOrderRequest
	37, // 51: oteldemo.OrderService.RefundOrder:input_type -> oteldemo.RefundOrderRequest
	39, // 52: oteldemo.AdService.GetAds:input_type -> oteldemo.AdRequest
	43, // 53: oteldemo.FeatureFlagService.GetFlag:input_type -> oteldemo.GetFlagRequest
	45, // 54: oteldemo.FeatureFlagService.CreateFlag:input_type -> oteldemo.CreateFlagRequest
	47, // 55: oteldemo.FeatureFlagService.UpdateFlag:input_type -> oteldemo.UpdateFlagRequest
	49, // 56: oteldemo.FeatureFlagService.ListFlags:input_type -> oteldemo.ListFlagsRequest
	51, // 57: oteldemo.FeatureFlagService.DeleteFlag:input_type -> oteldemo.DeleteFlagRequest
	5,  // 58: oteldemo.CartService.AddItem:output_type -> oteldemo.Empty
	4,  // 59: oteldemo.CartService.GetCart:output_type -> oteldemo.Cart
	5,  // 60: oteldemo.CartService.EmptyCart:output_type -> oteldemo.Empty
	7,  // 61: oteldemo.RecommendationService.ListRecommendations:output_type -> oteldemo.ListRecommendationsResponse
	9,  // 62: oteldemo.ProductCatalogService.ListProducts:output_type -> oteldemo.ListProductsResponse
	8,  // 63: oteldemo.ProductCatalogService.GetProduct:output_type -> oteldemo.Product
	12, // 64: oteldemo.ProductCatalogService.SearchProducts:output_type -> oteldemo.SearchProductsResponse
	14, // 65: oteldemo.ShippingService.GetQuote:output_type -> oteldemo.GetQuoteResponse
	16, // 66: oteldemo.ShippingService.ShipOrder:output_type -> oteldemo.ShipOrderResponse
	19, // 67: oteldemo.CurrencyService.GetSupportedCurrencies:output_type -> oteldemo.GetSupportedCurrenciesResponse
	18, // 68: oteldemo.CurrencyService.Convert:output_type -> oteldemo.Money
	23, // 69: oteldemo.PaymentService.Charge:output_type -> oteldemo.ChargeResponse
	25, // 70: oteldemo.PaymentService.Refund:output_type -> oteldemo.RefundResponse
	27, // 71: oteldemo.PaymentService.GetPaymentStatus:output_type -> oteldemo.PaymentStatus
	5,  // 72: oteldemo.EmailService.SendOrderConfirmation:output_type -> oteldemo.Empty
	32, // 73: oteldemo.CheckoutService.PlaceOrder:output_type -> oteldemo.PlaceOrderResponse
	34, // 74: oteldemo.OrderService.GetOrdersByEmail:output_type -> oteldemo.GetOrdersByEmailResponse
	36, // 75: oteldemo.OrderService.GetOrder:output_type -> oteldemo.OrderDetail
	38, // 76: oteldemo.OrderService.RefundOrder:output_type -> oteldemo.RefundOrderResponse
	40, // 77: oteldemo.AdService.GetAds:output_type -> oteldemo.AdResponse
	44, // 78: oteldemo.FeatureFlagService.GetFlag:output_type -> oteldemo.GetFlagResponse
	46, // 79: oteldemo.FeatureFlagService.CreateFlag:output_type -> oteldemo.CreateFlagResponse
	48, // 80: oteldemo.FeatureFlagService.UpdateFlag:output_type -> oteldemo.UpdateFlagResponse
	50, // 81: oteldemo.FeatureFlagService.ListFlags:output_type -> oteldemo.ListFlagsResponse
	52, // 82: oteldemo.FeatureFlagService.DeleteFlag:output_type -> oteldemo.DeleteFlagResponse
